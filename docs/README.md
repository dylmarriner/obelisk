...
| Set up the Hermes plugin with usage tracking hooks | [Hermes Plugin](../plugins/hermes-obelisk/README.md) |
...
5. **Leave self-improvement disabled** until you understand it — [Self-Improvement](SELF_IMPROVEMENT.md)
...
| Document | Contents |
|----------|----------|
| [Setup Guide](SETUP.md) | Requirements, building, installation, PATH setup, agent hooks installation, smoke tests, daily workflow, updating |
...
| [Agent Integrations](AGENT_INTEGRATIONS.md) | Claude Code, Codex, OpenCode, Hermes (with usage tracking), Paperclip, OpenClaw, Cline — install, verify, troubleshoot |
| [Self-Improvement](SELF_IMPROVEMENT.md) | Learning loop architecture, gaps, risks, recommended safeguards, v2 design |
| [Troubleshooting](TROUBLESHOOTING.md) | Binary not found, ledger failures, hook issues, pack too small/large, build failures, self-improvement |
...
| [Hermes Plugin](../plugins/hermes-obelisk/README.md) | Obelisk tools, usage tracking hooks, slash commands, CLI commands, skills |
